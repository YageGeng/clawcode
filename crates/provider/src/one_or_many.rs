//! Provider-owned non-empty one-or-many container.
//!
//! This type remains part of provider request compatibility and is intentionally
//! independent from the agent runtime protocol.
