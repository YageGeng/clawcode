//! This module primarily concerns orchestrating telemetry around provider
//! requests and responses. It includes tracing, serializing inputs and outputs,
//! and shaping spans for downstream observability tools.
